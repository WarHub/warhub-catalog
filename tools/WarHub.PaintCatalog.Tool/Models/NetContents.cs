...
/// `volumeMl: 17`. The committed vocabulary is exactly dropper 5,385 / jar 1,449 / pot 924 / tin
/// 115 / spray 30 (plus 644 null) across the 21 brand files, measured 2026-08-06 -- none of which
...
///
/// <c>weightG</c> IS NET CONTENTS, NOT SHIPPING WEIGHT. `hints.grams` exists on 1,843 evidence
/// observations (mfr-armypainter 727, mfr-scale75 562, mfr-turbodork 357, mfr-monument 197) and is
...
/// fabricate net contents on 1,843 records to fix 2. Nothing may feed <c>WeightG</c> that is not a
/// stated net content.
///
...
public static class NetContents
{
    ...
    /// no <c>WeightG</c> is present on either side -- 8,545 of 8,547 committed paint records,
    ...
    public static Claim Merge(Claim incoming, Claim current)
    {
        ...
        // unconditionally was a real defect: measured 2026-08-06, 212 committed pigment/powder/
        // paste/sand records carry both a volume and a container (29 of them exactly
